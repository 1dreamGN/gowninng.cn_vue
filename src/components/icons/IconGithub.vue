<template>
    <div data-aos="zoom-in">
      ...
      <div class="d-flex align-items-center justify-content-between">
        ...
        <a href="#" target="_blank" class="about-btn"><img src="../../assets/images/icon.svg" alt="Button"></a>
      </div>
    </div>
  </div>
</template>
...
.icon-path {
  ...
  stroke-dasharray: 4917; /* 设定路径的总长度 */
  stroke-dashoffset: 4917; /* 路径起始状态，完全隐藏 */
  fill: none; /* 初始不填充路径 */
}
...
@keyframes icon-path-animation {
  0% {
    stroke-dashoffset: 4917; /* 起始时路径完全隐藏 */
    fill: #000000; /* 初始路径颜色为白色 */
  }
  40% {
    stroke-dashoffset: 0; /* 路径开始绘制 */
    fill: #000000; /* 保持白色 */
  }
  60% {
    stroke-dashoffset: 0; /* 路径完全绘制 */
    fill: #ffffff; /* 颜色变为黑色 */
  }
  100% {
    stroke-dashoffset: 0; /* 路径绘制完成 */
    fill: #ffffff; /* 保持黑色 */
  }
}
...
/* 设置路径的边框颜色和宽度 */
.icon-path {
  stroke: #ffffff; /* 路径的边框颜色设置为黑色 */
  stroke-width: 6; /* 设置边框宽度 */
}
